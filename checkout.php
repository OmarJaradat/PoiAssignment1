                 ...
                 <div class="checkout-right">
                    ...
                    <div id="parentHorizontalTab">
                        <ul class="resp-tabs-list hor_1">
                            <li style="display: none;">Cash on delivery (COD)</li>
                            <li>Credit/Debit</li>
                            <!-- <li>Netbanking</li>
                                 ...
                                 <div class="vertical_post">
                                  <form action="#" method="post">
                                    ...
                                    <div class="swit-radio">								
                                        ...
                                        <div class="check_box_one"> <div class="radio_one"> <label><input type="radio" name="radio"><i></i>ANZ</label> </div></div>
                                        <div class="check_box_one"> <div class="radio_one"> <label><input type="radio" name="radio"><i></i>Westpac</label> </div></div>	
                                        <div class="check_box_one"> <div class="radio_one"> <label><input type="radio" name="radio"><i></i>ING Bank</label> </div></div>	
